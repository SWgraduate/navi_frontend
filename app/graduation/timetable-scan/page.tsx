                ...
                {images.map((img, idx) => (
                  ...
                  >
                    <div className="relative aspect-square w-full">
                      ...
                      <button
                        type="button"
                        className="absolute right-2 top-2 z-10 rounded-[4px] bg-black/40 px-1 py-0.5 text-ds-caption-14-m leading-ds-caption-14-m text-white underline underline-offset-2"
                        onClick={() => removeImage(idx)}
                        aria-label={`${idx + 1}번 사진 취소`}
                      >
                        해당 사진 취소
                      </button>
        ...
        {hasImages ? (
          <div className="flex gap-2">
            <Button
              ...
              variant="secondary"
              size="lg"
              className="flex-1 border-primary bg-primary/5 text-primary hover:bg-primary/10 active:bg-primary/15"
              onClick={() => fileInputRef.current?.click()}
            >
              {t("graduation.timetableScan.addPhoto")}
            </Button>
            <Button
              type="button"
              variant="primary"
